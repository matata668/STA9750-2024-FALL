...
1.  **Bronx**:
    -   The ZIP codes **10457 and 10458** show **higher rat sighting** (above 12,000) while also exhibiting a significant number of restaurants with **Grade B and C**.
...
2.  **Brooklyn**:
    -   ZIP codes **11215 and 11222** show the highest rat activity (over 20,000), corresponding to relatively high numbers of restaurants with **Grade B and C**.
...
3.  **Manhattan**:
    ...
    -   Despite a significant concentration of lower-graded restaurants, rat sighting remain moderate compared to other boroughs, suggesting **more effective urban management** in some areas.
4.  **Queens**:
    -   ZIP codes **11385 and 11373** show the **highest rat sighting** and a considerable number of restaurants with **Grade B and C**.
    -   Rat activity appears to peak sharply in specific ZIP codes, correlating with localized concentrations of lower-graded restaurants.
5.  **Staten Island**:
    -   Staten Island has the **lowest rat ** across all ZIP codes, with a small number of lower-graded restaurants.
    -   ZIP code **10301** has the highest rat sighting (600) but relatively fewer restaurants compared to other boroughs.
...
Outdoor dining in NYC, expanded during the COVID-19 pandemic, supported businesses but led to sanitation issues like food scraps and poorly stored trash, attracting rats and increasing health violations. To assess its impact on rat infestations, we analyzed rat sightings within a 100-meter radius of outdoor dining violations during 2020-2022, identifying trends and comparing infestation rates to prior years.
